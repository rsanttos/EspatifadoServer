...
public class UsuarioService {
	...
	/**
	 * Service da entidade Pessoa que irá realizar a persistência dos dados da
	 * entidade Pessoa
	 */
	...
	/**
	 * Método que consulta e verifica se um usuário já existe a partir do CPF
	...
	/**
	 * Método que consulta e retorna o objeto da entidade Usuario a partir do
	 * login recebido como parâmetro
	 * 
	 * @param login
	 * @return
	 */
	...
	/**
	 * Método que efetua a persistência dos dados pessoais do usuário recebido
	 * como parâmetro
	 * 
	 * @param login
	 * @return
	...
	/**
	 * Método que consulta e retorna o objeto da entidade Usuario a partir do id
	 * recebido como parâmetro
	 * 
	 * @param id
	 * @return
